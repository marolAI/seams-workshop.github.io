...
* How can we automatically gather data? 
    ...
    <!--
    -Choices website applications connected to relational databases
    -
    -->
...
* What kind of checkpointing / intermediate outputs / caching should be done? 
     ...
     <!--
    Value of checkpointing to debugging, but also scaling up to supercomputer approaches, use in alternative analysis /
...
-serialize() is your best best for getting R objects out of and back into R the way you had them, but doesn’t do much for you wneh communicating with other systems.
...
I’m considering msgpack as a convenient wire format for embedded devices.
      -->
