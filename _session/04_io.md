...
* Which formats for which tasks?
    ...
    -To optimise query perfomance it is important to have columnar data so that searches can be done based on the columns. Searching all columns results in more time for  
     output generation.
