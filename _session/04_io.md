...
* Why we should care about the topic and how we should think about it?  
    ...
    Scientific research requires the use of data in modelling so as to predict progression and future burden of diseases as an example. It is therefore not 
...
* Which formats for which tasks?
     ...
     <!--
     Discuss on input decisions to be made.
     
     Tasks involving storage and retrieval of hierachical data will require the use of Database technologies. Database technologies vary  
     also depending on the volume of data. Standards such as sql are revelant for querying data frames or data sets.
    No content as yet
    -->
