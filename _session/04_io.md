...
* How can we automatically gather data? 
    ...
    <!--
    -Making observations/ survey
    -Research hubs can be made use of as they offer centralised data storage
...
* Which formats for which tasks?
     ...
     <!--
     Discuss the formats for which tasks, example in simulating weather formats ie raw text, structured text (csv), binary or databases
