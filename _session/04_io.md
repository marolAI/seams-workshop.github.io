...
Questions to ask students:
 ...
 - what kind of data do you have (both format, but also serial vs hierarchical vs ???, web query?)
 - what formats are appropriate for your programming needs?  need to understand where work falls on the following spectra:
 - e.g., serial vs hierarchical, sync vs asynchronous, small vs large, plaintext vs binary
 - how do these properties influence choices about IO?
