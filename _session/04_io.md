...
<!--
The need to move towards hierarchical data.
...
* How do we capture / document data cleaning / curation / reshaping process?  
     ...
     <!--
    This can be achieved through use of Software tools packaged in more cohesive and consistent ways, which leads to:
